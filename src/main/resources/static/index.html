...
<div id="dowebok">
    <div class="section page1">
        ...
        <img class="img" src="images/banner11.png" alt="" style="display: block;">
        <img class="img" src="images/banner12.jpg" alt="">
        <img class="img" src="images/banner13.jpg" alt="">
        <!-- 添加文字 -->
        ...
        <div class="container">
            <div class="row">
                <div class="notice col-lg-4 col-md-4">
                    ...
                    <div class="more"><a href="zhongxin.html">查看更多公告</a></div>
                    <div class="news">
                            <span class="col-sm-6 col-xs-6">
                                <img src="images/bg3.png" alt="">
                                <ul>
                                    <li><a href="">安全用电管理制度</a></li>
                ...
                <div class="tupian col-lg-4 col-md-4 hidden-sm hidden-xs">
                    <div class="img1">
                        <img src="images/m4.jpg" alt="" onMouseOver="this.src='images/m2.jpg'"
                             onMouseOut="this.src='images/m4.jpg'">
                    </div>
                    <div class="img1">
                        <img src="images/m2.jpg" alt="" onMouseOver="this.src='images/m4.jpg'"
                             onMouseOut="this.src='images/m2.jpg'">
                    </div>
                </div>
            </div>
        </div>
